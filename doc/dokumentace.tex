...
\begin{document}
    ...
    \section{Implementácia}
        ...
        Funkcia číta znaky zo zadaného súboru(spravidla \emph{stdin}). Znaky sú spracované pomocou konečného automatu. 
        Ak sa automat dostane do konečného stavu, funkcia vráti hodnotu \emph{true} a podľa spracovaných znakov nastaví
        token predaný v argumente. 
        ...
        Ak nastane počas lexikálnej analýzy chyba, vráti funkcia hodnotu \emph{false} a token nenastavuje. 
        ...
        V poli reťazcov sú uložené všetky kľúčové slová a \emph{binárnym vyhľadávaním} sa testuje, či sa jedná
        o identifikátor alebo kľúčové slovo.
