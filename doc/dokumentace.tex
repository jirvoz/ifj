...
\begin{document}
    ...
    \section{Implementácia}
        ...
        \subsection{Vstavané funkcie}
            V překladači jsme implementovali i čtyři vestavěné funkce pro jazyk IFJ17.
    ...
    jednotlivé časti a vyhli sa zbytočným chybám.
        ...
        Pre správu a zdielanie zdrojových súborov sme využili verzovací systém \emph{Git} a webovú službu GitHub pro vzdialene ukladánie, ktorú sme už 
    ...
    Pre správne fungovanie tímu bola potrebná dobrá komunikácia a řízení a přidělování úkolů, ktoré pretvaly počas celého
